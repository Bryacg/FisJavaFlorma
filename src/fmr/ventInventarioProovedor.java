...
public class ventInventarioProovedor extends javax.swing.JFrame {
...
//    }
     ...
     public void RefrescarProvedor(){
         // 
       while(modelo.getRowCount()>0){
           modelo.removeRow(0);
       } 
       for(usuario us : usu.readpROVEDOR()){
    ...
    public ventInventarioProovedor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnProvedor.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnProvedor.setForeground(new java.awt.Color(0, 204, 0));
    ...
    private void btnInvntarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInvntarioMouseClicked
         this.setVisible(false);
          ventInventarioProovedor c = new ventInventarioProovedor();
          c.setVisible(true);
