...
public class ventInventarioVentas extends javax.swing.JFrame {
...
//    }
     ...
     public void RefrescarVenta(){
       ...
       for(venta v : ven.readC()){
           Object fila[] = new Object[7];
           fila[0] = v.getIdVenta();
           fila[1] = v.getIdCliente();
           fila[2] = v.getIdCajero();
           fila[3] = v.getFecha();
           fila[4] = v.getSubtotal();
           fila[5] = v.getTotal();
    ...
    private void initComponents() {
        ...
        btnVentas.setForeground(new java.awt.Color(0, 204, 0));
    ...
    private void btnInvntarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInvntarioMouseClicked
         this.setVisible(false);
          ventInventarioVentas c = new ventInventarioVentas();
          c.setVisible(true);
